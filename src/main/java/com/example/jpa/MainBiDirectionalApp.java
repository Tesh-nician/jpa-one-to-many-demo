...
public class MainBiDirectionalApp {
    public static void main(String[] args) {
        Post post = new Post("BD post title","BD Post description","BD post content");

        Comment comment1 = new Comment("Great post!");
        comment1.setPost(post);
        Comment comment2 = new Comment("Comment 2 on the same post");
